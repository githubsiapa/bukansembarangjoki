...
<head>
	...
	<link href='images/km1.jpg' rel='SHORTCUT ICON' />
</head>
...
<body>
	...
	<div class="super_container">
					...
					<div class="row">
						<div class="col">
							<div class="header_content d-flex flex-row align-items-center justify-content-start">
								<div class="logo"><a href="index.php">Kencana Media</a></div>
								<nav class="main_nav">
									<ul>
										...
										<?php if($id_customer != ""){ ?>
										<li><a href="order.php">Buku Saya</a></li>
										<?php } ?>
									</ul>
								</nav>
		...
		<div class="home">
			<div class="home_container">
				<div class="home_background" style="background-image:url(images/footer4.jpg)"></div>
				<div class="home_content_container">
					<div class="container">
						<div class="row">
							<div class="col">
								<div class="home_content">
									<div class="home_title"><h1 style="color:black; text-transform: uppercase; font-family: Lucida Handwriting, Cursive;">Buku
										<?php echo $namakategori; ?><span>.</span></h1></div>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col">
						...
						<div class="sorting_bar d-flex flex-md-row flex-column align-items-md-center justify-content-md-start">
							<?php 
								...
								$result = mysqli_query($con, $query);
								$jumlah_barang = mysqli_num_rows($result);

							?>	
						<div class="results">Showing <span><?php echo $jumlah_barang; ?></span> results</div>
	...
	<div class="icon_boxes">
			<div class="container">
				<div class="row icon_box_row">
					...
					<div class="col-lg-4 icon_box_col">
						<div class="icon_box">
							<div class="icon_box_image"><img src="images/icon_1.png" alt=""></div>
							<div class="icon_box_title">Gratis Ongkir Se-Jawa</div>
							<div class="icon_box_text">
								<p>Gratis Ongkir Pulau Jawa Non Minimum Selama Periode Juli 2022.</p>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4 icon_box_col">
						<div class="icon_box">
							<div class="icon_box_image"><img src="images/icon_2.png" alt=""></div>
							<div class="icon_box_title">Gratis Pengembalian</div>
							<div class="icon_box_text">
								<p>Khawatir buku tidak cocok? Jangan khawatir, karena apapun alasannya kembalikan di Kencana Media gratis & mudah!</p>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4 icon_box_col">
						<div class="icon_box">
							<div class="icon_box_image"><img src="images/icon_3.png" alt=""></div>
		...
		<footer class="footer">
			<div class="footer_background" style="background-image:url(images/footer6.jpg)"></div>
			<div class="container">
				<div class="row">
					<div class="col">
						<div class="footer_content d-flex flex-lg-row flex-column align-items-center justify-content-lg-start justify-content-center">
							<div class="footer_logo"><a href="index.php">Kencana Media</a></div>
							<div class="copyright ml-auto mr-auto">
								<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
								Copyright &copy;<script>
								</script> All rights reserved | Kencana Media <br>
								<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
							</div>
						</div>
					</div>
