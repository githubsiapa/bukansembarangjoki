									...
									<ul>
										...
										<li class="hassubs">
											...
											<ul>
												<?php
													$query = 
													"SELECT * from kategori order by nama_kategori LIMIT 10";
									...
									<div class="col">
										<div class="home_slider_content" data-animation-in="fadeIn" data-animation-out="animate-out fadeOut">
											<div class="home_slider_title">
												<font size="5px">Toko Buku dengan beragam </font>
												<br>Jenis Buku.
											</div>
											<div class="home_slider_subtitle">Selamat Datang di &nbsp;<font color="red"><b>Kencana Media</font> </div>											
